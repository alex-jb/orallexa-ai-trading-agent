...
Usage:
    ...
    label = t("bull_coach", lang="ja")   # -> "ブルコーチ"

Supported languages: en, zh, ja.
"""
...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "scalp":                    {"en": "Scalp",                   "zh": "超短",              "ja": "スキャル"},
    "intra":                    {"en": "Intra",                   "zh": "日内",              "ja": "デイ"},
    "swing":                    {"en": "Swing",                   "zh": "波段",              "ja": "スイング"},
    "last":                     {"en": "Last",                    "zh": "上次",              "ja": "前回"},
    "voice_on":                 {"en": "Voice ON",                "zh": "语音 开",           "ja": "音声 ON"},
    "voice_off":                {"en": "Voice OFF",               "zh": "语音 关",           "ja": "音声 OFF"},
    "lang_label":               {"en": "Lang:",                   "zh": "语言:",             "ja": "言語:"},
    "why":                      {"en": "Why?",                    "zh": "为什么?",           "ja": "なぜ?"},
    "tech_details":             {"en": "Technical Details",       "zh": "技术详情",          "ja": "テクニカル詳細"},
    "analysis_complete":        {"en": "Analysis complete.",      "zh": "分析完成。",        "ja": "分析が完了しました。"},
    "you":                      {"en": "You",                     "zh": "你",                "ja": "あなた"},
    "thinking":                 {"en": "thinking…",          "zh": "思考中…",      "ja": "思考中…"},
    "transcribing":             {"en": "transcribing…",      "zh": "转录中…",      "ja": "文字起こし中…"},
    "no_speech":                {"en": "(no speech detected)",    "zh": "(未检测到语音)",    "ja": "(音声を検出できませんでした)"},
    ...
    "hint": {
        ...
        "ja": (
            ...
            "  \"TSLA スイング\"\n"
            "  \"このチャートをスクショ\"\n"
            "  または Ctrl+Shift+S を押す"
        ),
    },

    # ── Character window: state bubbles ──────────────────────────
    "listening":                {"en": "listening...",            "zh": "在听...",           "ja": "聞いてます..."},
    ...
    "checking_charts":          {"en": "checking charts...",     "zh": "看图中...",         "ja": "チャート確認中..."},
    "thinking_bubble":          {"en": "thinking...",            "zh": "思考中...",         "ja": "思考中..."},
    "strong_signal":            {"en": "strong signal!",         "zh": "强信号!",           "ja": "強いシグナル!"},
    "looking_good":             {"en": "looking good!",          "zh": "看好!",             "ja": "良さそう!"},
    "setup_confirmed":          {"en": "setup confirmed!",      "zh": "形态确认!",         "ja": "セットアップ確認!"},
    "careful_here":             {"en": "careful here...",        "zh": "小心...",           "ja": "ここは注意..."},
    ...
    "careful_high_risk":        {"en": "careful — high risk",
                                 "zh": "小心 — 高风险",
                                 "ja": "注意 — 高リスク"},
    "signal_looks_good":        {"en": "signal looks good!",     "zh": "信号不错!",         "ja": "良いシグナル!"},
    ...
    "already_analyzing":        {"en": "already analyzing...",   "zh": "正在分析中...",     "ja": "すでに分析中..."},
    ...
    "tray_screenshot":          {"en": "Screenshot Analysis (Ctrl+Shift+S)",
                                 ...
                                 "ja": "スクショ分析 (Ctrl+Shift+S)"},
    "tray_show_hide":           {"en": "Show / Hide",            "zh": "显示 / 隐藏",       "ja": "表示 / 非表示"},
    "tray_scalp":               {"en": "Mode: Scalp (5m)",       "zh": "模式: 超短 (5m)",   "ja": "モード: スキャル (5m)"},
    "tray_intraday_15m":        {"en": "Mode: Intraday (15m)",   "zh": "模式: 日内 (15m)",  "ja": "モード: デイ (15m)"},
    "tray_intraday_1h":         {"en": "Mode: Intraday (1h)",    "zh": "模式: 日内 (1h)",   "ja": "モード: デイ (1h)"},
    "tray_swing":               {"en": "Mode: Swing (1D)",       "zh": "模式: 波段 (1D)",   "ja": "モード: スイング (1D)"},
    ...
    "mode_intraday":            {"en": "Intraday",               "zh": "日内",              "ja": "デイトレ"},
    "mode_swing":               {"en": "Swing",                  "zh": "波段",              "ja": "スイング"},

    # ── Risk levels (card metrics) ───────────────────────────────
    "risk_low":                 {"en": "Low",                    "zh": "低",                "ja": "低"},
    "risk_medium":              {"en": "Moderate",               "zh": "中等",              "ja": "中"},
    ...
    "error_api_key_missing":    {"en": "API key not set. Check ANTHROPIC_API_KEY.",
                                 ...
                                 "ja": "APIキーが未設定です。ANTHROPIC_API_KEY を確認してください。"},
    ...
    "step_fetching_data":       {"en": "Fetching market data...",   "zh": "获取市场数据...",   "ja": "市場データ取得中..."},
    "step_computing":           {"en": "Computing indicators...",   "zh": "计算指标...",       "ja": "指標計算中..."},
    "step_analyzing":           {"en": "Running analysis...",       "zh": "执行分析...",       "ja": "分析実行中..."},
    "step_ai_overlay":          {"en": "Claude AI reviewing...",    "zh": "Claude AI 审核...", "ja": "Claude AI が確認中..."},
    ...
    "angry_reaction":           {"en": "Ugh, stop loss hit...",     "zh": "唉，止损了...",     "ja": "うう、損切りになった..."},
    ...
    "market_check_ok":          {"en": "{ticker} is quiet. No action needed.",
                                 "zh": "{ticker} 平稳，无需操作。",
                                 "ja": "{ticker} は静かです。アクション不要。"},

    # ── Particle effects ─────────────────────────────────────────
    "confetti":                 {"en": "Bullish!",                  "zh": "看涨!",             "ja": "強気!"},

    # ── Jump animation ───────────────────────────────────────────
    "jump_excited":             {"en": "Let's go!",                 "zh": "冲!",               "ja": "行こう!"},

    # ── Mood-aware idle tips ─────────────────────────────────────
    "streak_positive_1":        {"en": "On a roll!",                "zh": "连胜中!",           "ja": "好調キープ!"},
    "streak_positive_2":        {"en": "Stay disciplined on streaks", "zh": "保持冷静，别大意", "ja": "連勝中こそ規律を"},
    "streak_negative_1":        {"en": "Tough streak. Review your plan.", "zh": "别气馁，回顾策略",
                                                                       "ja": "つらい時こそ戦略を見直そう"},
    "streak_negative_2":        {"en": "Take a break, reset.",      "zh": "连亏了，休息一下",  "ja": "一度休憩してリセット"},

    # ── Pet interaction ──────────────────────────────────────────
    "pet_1":                    {"en": "Moo~ ♥",                    "zh": "哞~ ♥",             "ja": "モォ~ ♥"},
    "pet_2":                    {"en": "Bull happy!",               "zh": "嘿嘿~",             "ja": "ブル、嬉しい!"},
    "pet_3":                    {"en": "Hey~",                      "zh": "摸摸~",             "ja": "なでなで~"},

    # ── Missing dependency warnings ──────────────────────────────
    "yfinance_missing":         {"en": "pip install yfinance for market alerts",
                                 "zh": "请安装 yfinance 以启用市场提醒",
                                 "ja": "市場アラート用に yfinance をインストールしてください"},
}
