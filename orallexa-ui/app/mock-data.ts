...
export function mockDailyIntel() {
  return {
    ...
    options_flow: [
      ...
      { ticker: "TSLA", type: "put" as const, premium: "$8.7M", strike: "$250", expiry: "Apr 11", sentiment: "bearish" as const, unusual: true },
      { ticker: "AAPL", type: "call" as const, premium: "$5.2M", strike: "$225", expiry: "May 16", sentiment: "bullish" as const, unusual: false },
      { ticker: "META", type: "put" as const, premium: "$6.1M", strike: "$600", expiry: "Apr 18", sentiment: "bearish" as const, unusual: true },
      { ticker: "AMD", type: "call" as const, premium: "$4.8M", strike: "$140", expiry: "Apr 25", sentiment: "bullish" as const, unusual: true },
      { ticker: "COIN", type: "call" as const, premium: "$3.9M", strike: "$280", expiry: "Apr 11", sentiment: "bullish" as const, unusual: false },
    ],
    macro: [
      { label: "VIX", value: "14.2", change: -1.8, direction: "down" as const },
      { label: "DXY", value: "104.3", change: 0.2, direction: "up" as const },
      { label: "10Y", value: "4.32%", change: 0.05, direction: "up" as const },
      { label: "WTI", value: "$78.5", change: -0.9, direction: "down" as const },
      { label: "Gold", value: "$2,340", change: 0.4, direction: "up" as const },
      { label: "BTC", value: "$91,200", change: 3.2, direction: "up" as const },
    ],
    econ_calendar: [
      { date: today, time: "08:30", event: "CPI (MoM)", impact: "high" as const, forecast: "0.3%", previous: "0.4%" },
      { date: today, time: "10:00", event: "Consumer Sentiment", impact: "medium" as const, forecast: "76.5", previous: "77.2" },
      { date: new Date(Date.now() + 86400000).toISOString().slice(0, 10), time: "14:00", event: "FOMC Minutes", impact: "high" as const },
      { date: new Date(Date.now() + 86400000).toISOString().slice(0, 10), time: "08:30", event: "Jobless Claims", impact: "medium" as const, forecast: "215K", previous: "219K" },
      { date: new Date(Date.now() + 172800000).toISOString().slice(0, 10), time: "08:30", event: "PPI (MoM)", impact: "high" as const, forecast: "0.2%", previous: "0.3%" },
      { date: new Date(Date.now() + 259200000).toISOString().slice(0, 10), time: "10:00", event: "NVDA Earnings", impact: "high" as const },
    ],
    fear_greed: {
      score: 68,
      label: "Greed",
      components: [
        ...
        { name: "Volume", value: 62, signal: "greed" as const },
        { name: "Put/Call Ratio", value: 55, signal: "neutral" as const },
        { name: "Breadth", value: 71, signal: "greed" as const },
        { name: "Volatility", value: 78, signal: "greed" as const },
        { name: "Safe Haven", value: 45, signal: "neutral" as const },
      ],
    },
  };
}
