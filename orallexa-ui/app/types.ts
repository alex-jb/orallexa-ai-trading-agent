...
export interface PredictionMarket { question: string; yes_price: number; volume_24hr: number; end_date: string; sign: number; platform?: "polymarket" | "kalshi" | string; }
